    ...
    >
      ...
      <div className="truck-card__details">
        ...
        <div className="truck-card__price-range">
          ...
          <span className="truck-card__price-label text-13 text-secondary ">Onwards</span>

        </div>
        <div className="d-flex w-auto mt-5 ">
          <button className=" btn btn-primary d-flex justify-content-center   flex-grow-1 text-center  " >View More</button>
        </div>
      </div>
    </div>
            </Link>

...
const BlogNavigator = ({ blogs, id }) => {
  ...
  return (
    <div className="row y-gap-30 justify-between w-100">
      <div className="col-auto w-50">
        <div onClick={routeToPrevious} className="link-like-container">
          ...
          <div className="text-15 ml-40 w-auto">{previous?.heading}</div>
        </div>
      </div>
      <div className="col-auto text-right pe-auto w-50">
        ...
        <div className="text-15 mr-40 w-auto">{next?.heading}</div>
        </div>
      </div>
